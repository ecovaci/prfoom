...
import org.kpax.prfoom.ExitCodes;
...
public class AppFrame extends JFrame {
    ...
    private boolean isValidInput() {
        ...
        try {
            ...
            SwingUtils.showErrorMessage("Test Connection Error", "Wrong user/password!");
            return false;
        } catch (UnknownHostException e) {
            SwingUtils.showErrorMessage("Test Connection Error", "Wrong proxy host!");
            return false;
        } catch (HttpHostConnectException e) {
            SwingUtils.showErrorMessage("Test Connection Error", "Wrong proxy port!");
            return false;
        } catch (IOException e) {
            SwingUtils.showErrorMessage("Test Connection Error", e.getMessage());
            return false;
        }
